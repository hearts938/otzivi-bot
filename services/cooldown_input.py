...
COOLDOWN_HOURS_PROMPT = (
    "Укажите <b>кулдаун перед проверкой</b> (задержка, пока отзыв не попадёт админу) в <b>часах</b>.\n\n"
...
RECHARGE_HOURS_PROMPT = (
    "Укажите <b>перезарядку между заданиями</b> (пауза для пользователя на этом сервисе после отправки на проверку) в <b>часах</b>.\n\n"
    "<b>Формат:</b> как у кулдауна проверки — <code>0</code>, <code>4</code>, <code>4.5</code> …"
)
